	                ...
	                <form role="form" id="modifyForm" method="post" action="${path}/article/paging/search/modify">
	                    <div class="box box-primary">
	                        <div class="box-header with-border">
	                            <h3 class="box-title" style="font-family: 'Noto Sans KR', sans-serif;">게시글 수정</h3>
	                        </div>
	                        <div class="box-body">
	                            ...
	                            <div class="form-group">
	                                <label style="color:#000000" for="title" style="font-family: 'Noto Sans KR', sans-serif;">제목</label>
	                                <input class="form-control" id="title" name="title" placeholder="제목을 입력해주세요" value="${article.title}">
	                            </div>
	                            <div class="form-group">
	                                <label style="color:#000000" for="content" style="font-family: 'Noto Sans KR', sans-serif;">내용</label>
	                                <textarea class="form-control" id="content" name="content" rows="30"
	                                          placeholder="내용을 입력해주세요" style="resize: none;">${article.content}</textarea>
	                            </div>
	                            <div class="form-group">
	                                <label  style="color:#000000" for="writer" style="font-family: 'Noto Sans KR', sans-serif;">작성자</label>
	                            ...
	                            <div class="form-group">
	                                <div class="fileDrop">
	                                    ...
	                                    <br/>
	                                    <br/>
	                                    <p style="color:#000000" class="text-center"><i class="fa fa-paperclip"></i> 첨부파일을 드래그해주세요.</p>
	                                </div>
	                            </div>
	                        </div>
